...
public class WorkoutRepository : IWorkoutRepository
{
    ...
    public List<WorkoutExercise> GetExercises(int workoutId, string applicationUserId)
    {
        return _context.WorkoutExercises
            .Where(e => e.WorkoutId == workoutId)
            .Where(e => e.ApplicationUser.Id == applicationUserId)
            .ToList();
    ...
    {
        product.ApplicationUser = _context.ApplicationUsers.Find(product.ApplicationUser);
